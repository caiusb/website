...
export default function Astrophotography() {
    return (
        <Layout>
            <h1>Astrophotograhy</h1>
            <p>Welcome to my astrophotography page.</p>
            ...
            <img src="/astrophotography/M17-20250629-10mins-IRCUT.webp" width="500" alt="M17"/>
            ...
            <img src="/astrophotography/M20-20250630-32mins-IRCUT.webp" width="500" alt="M20"/>
        </Layout>
    );
}
